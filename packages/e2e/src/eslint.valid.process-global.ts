...
export const name = 'eslint.valid.process-global'
...
export const test: Test = async ({ Command, FileSystem, Main, Workspace }) => {
  ...
  const text = 'console.log(process.cwd())'
  await FileSystem.writeFiles([
    {
      content:
        "export default [{ languageOptions: { globals: { console: 'readonly', process: 'readonly' } }, rules: { 'no-undef': 'error' } }]",
