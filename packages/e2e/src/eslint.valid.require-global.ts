...
export const name = 'eslint.valid.require-global'
...
export const test: Test = async ({ Command, FileSystem, Main, Workspace }) => {
  ...
  const text = "console.log(require('example'))"
  await FileSystem.writeFiles([
    {
      content:
        "export default [{ languageOptions: { globals: { console: 'readonly', require: 'readonly' } }, rules: { 'no-undef': 'error' } }]",
