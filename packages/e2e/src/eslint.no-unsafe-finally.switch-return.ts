...
export const name = 'eslint.no-unsafe-finally.switch-return'
...
export const test: Test = async ({ Command, FileSystem, Main, Workspace }) => {
  ...
  const text =
    'function run(value) { try { console.log(value) } finally { switch (value) { case 1: return 1; default: console.log(2) } } } run(1)'
