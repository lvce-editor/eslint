...
export const name = 'eslint.valid.dirname-global'
...
export const test: Test = async ({ Command, FileSystem, Main, Workspace }) => {
  ...
  const text = 'console.log(__dirname)'
  await FileSystem.writeFiles([
    {
      content:
        "export default [{ languageOptions: { globals: { console: 'readonly', __dirname: 'readonly' } }, rules: { 'no-undef': 'error' } }]",
