...
export const name = 'eslint.valid.global-global'
...
export const test: Test = async ({ Command, FileSystem, Main, Workspace }) => {
  ...
  const text = 'console.log(global)'
  await FileSystem.writeFiles([
    {
      content:
        "export default [{ languageOptions: { globals: { console: 'readonly', global: 'readonly' } }, rules: { 'no-undef': 'error' } }]",
