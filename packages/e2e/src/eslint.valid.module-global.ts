...
export const name = 'eslint.valid.module-global'
...
export const test: Test = async ({ Command, FileSystem, Main, Workspace }) => {
  ...
  const text = 'module.exports = { value: 1 }'
  await FileSystem.writeFiles([
    {
      content:
        "export default [{ languageOptions: { globals: { console: 'readonly', module: 'readonly' } }, rules: { 'no-undef': 'error' } }]",
