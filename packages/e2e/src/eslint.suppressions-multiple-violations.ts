...
export const name = 'eslint.suppressions-multiple-violations'
...
export const test: Test = async ({ Command, FileSystem, Main, Workspace }) => {
  ...
  await FileSystem.setFiles([
    ...
    {
      content: JSON.stringify({ 'test.js': { 'no-debugger': { count: 2 } } }),
      uri: `${tmpDir}/eslint-suppressions.json`,
    },
    {
      content: text,
      uri,
