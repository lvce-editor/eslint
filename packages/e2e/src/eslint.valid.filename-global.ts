...
export const name = 'eslint.valid.filename-global'
...
export const test: Test = async ({ Command, FileSystem, Main, Workspace }) => {
  ...
  const text = 'console.log(__filename)'
  await FileSystem.writeFiles([
    {
      content:
        "export default [{ languageOptions: { globals: { console: 'readonly', __filename: 'readonly' } }, rules: { 'no-undef': 'error' } }]",
